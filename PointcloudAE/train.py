...
from loss import SWD, Quasi_SWD,Randomized_Quasi_SWD,Spiral_Quasi_SWD,Radomized_Spiral_Quasi_SWD,Naive_Quasi_SWD,Randomized_Naive_Quasi_SWD,Randomized_Rotation_Quasi_SWD,Randomized_Rotation_Naive_Quasi_SWD,OptD_Quasi_SWD,OptC_Quasi_SWD,Randomized_OptD_Quasi_SWD,Randomized_OptC_Quasi_SWD
...
def main():
    ...
    parser.add_argument("--loss", default="swd", help="[swd, gqswd,eqswd, sqswd, cqswd, dqswd, rgqswd, rrqswd, reqswd, rreqswd, rsqswd, rdqswd, rcqswd ]")
    ...
    parser.add_argument("--L", default=100, type=int, help="L")
    ...
    elif args["loss"] == "eqswd":
        loss_func = Quasi_SWD(args["num_projs"], device)
    elif args["loss"] == "gqswd":
        loss_func = Naive_Quasi_SWD(args["num_projs"], device)
    elif args["loss"] == "rgqswd":
        loss_func = Randomized_Naive_Quasi_SWD(args["num_projs"], device)
    elif args["loss"] == "rrgqswd":
        loss_func = Randomized_Rotation_Naive_Quasi_SWD(args["num_projs"], device)
    elif args["loss"] == "sqswd":
        loss_func = Spiral_Quasi_SWD(args["num_projs"], device)
    elif args["loss"] == "reqswd":
        loss_func = Randomized_Quasi_SWD(args["num_projs"], device)
    elif args["loss"] == "cqswd":
        loss_func = OptC_Quasi_SWD(args["num_projs"], device)
    elif args["loss"] == "rcqswd":
        loss_func = Randomized_OptC_Quasi_SWD(args["num_projs"], device)
    elif args["loss"] == "dqswd":
        loss_func = OptD_Quasi_SWD(args["num_projs"], device)
    elif args["loss"] == "rdqswd":
        loss_func = Randomized_OptD_Quasi_SWD(args["num_projs"], device)
    elif args["loss"] == "rreqswd":
        loss_func = Randomized_Rotation_Quasi_SWD(args["num_projs"], device)
    elif args["loss"] == "rsqswd":
        loss_func = Radomized_Spiral_Quasi_SWD(args["num_projs"], device)
